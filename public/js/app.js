...
var app = new Vue({
    ...
    methods: {
        shorten: function shorten() {
            ...
            axios.post('/shorten', {
                ...
                _this.shortLink = response.data;
                _this.loading = false;
            }).catch(function (error) {
                _this.errMsg = error.response.data.errors.long_url[0];
                _this.loading = false;
            });
        },
        signIn: function signIn() {
            ...
            axios.post('/login', {
                ...
                _this2.login.disableBtn = false;
                _this2.login.errMsg = error.response.data.message;
            });
        },
    ...
    computed: {
        isEnsabled: function isEnsabled() {
